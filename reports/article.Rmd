...
`r format(N_njr$tot, big.mark = ",")` patients were included (Figure \@ref(fig:flowchartnjr)).
...
The ability of the reduced model to estimate probabilities of death within 90 days is further illustrated in Figure \@ref(fig:separationhist) and \@ref(fig:separationdensity). Model calibration was good for estimated probabilities up to 3 % and acceptable up to 5 %, although with predicted probabilities usually higher than observed proportions (Figure \@ref(fig:calibration)). 
