...
author: Anne Garland`*`^1,2,3^, Erik Bulow`*`^2,4^, Erik Lenguerrand^5^, Ashley Blom^5,6^, J. Mark Wilkinson^7^, Adrian Sayers^5^, Ola Rolfson2,4^, Nils P. Hailer^1,2^
date: '`r Sys.Date()`'
...
Patients from NJR had an unadjusted risk of 90 day mortality of `r njr_surv`, which was higher compared to the derivation cohort from Sweden.
